...
def register_hcu_postproc(func: Callable[[str, Target], str], override: bool = True):
    """Register a post-processing function for HCU code generation.
    ...
    Args:
        ...
        override: Whether to override existing registered function. Defaults to True.
    """
    tvm_ffi.register_global_func("tilelang_callback_hcu_postproc", f=func, override=override)
...
def register_hcu_postproc_callback(func: Callable | bool = None, override: bool = True):
    """Decorator for registering HCU post-processing callback function.
    ...
    Can be used with or without parentheses:
        ...
        @register_hcu_postproc_callback(override=False)
        def func(code, target): ...
    ...
    """
    if callable(func):
        register_hcu_postproc(func, override)
        return func
    ...
    if func is None or isinstance(func, bool):
        ...
        def _register(fn: Callable[[str, Target], str]):
            register_hcu_postproc(fn, _override)
            return fn
