...
// Lexical map authorizing HCU codegen to move blockIdx-dependent terms from
// ordinary VM buffer-store offsets into the 64-bit resource base.
static constexpr const char *kBufferOpsRebaseMap = "buffer_ops_rebase_map";
