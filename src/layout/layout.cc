  ...
  refl::GlobalDef()
      ...
      .def("tl.make_gemm_fragment_hcu",
           [](int block_m, int block_n, int num_warp_m, int num_warp_n,
              int num_warp_k, int element_bits, int min_n_per_warp) {
             return makeGemmFragmentHCU(block_m, block_n, num_warp_m,
                                        num_warp_n, num_warp_k, element_bits,
                                        min_n_per_warp);
           })
      .def("tl.make_gemm_fragment_hcu_lit",
           [](int block_m, int block_n, int num_warp_m, int num_warp_n,
              int num_warp_k, int element_bits, int min_n_per_warp) {
             return makeGemmFragmentHCULit(block_m, block_n, num_warp_m,
                                           num_warp_n, num_warp_k, element_bits,
                                           min_n_per_warp);
           })
      .def("tl.make_gemm_fragment_a_hcu",
           [](int block_m, int block_n, int block_k, int num_warp_m,
              int num_warp_n, int num_warp_k, int element_bits, int k_pack,
              bool transposed) {
             return makeGemmFragmentAHCU(block_m, block_n, block_k, num_warp_m,
                                         num_warp_n, num_warp_k, element_bits,
                                         k_pack, transposed);
           })
      .def("tl.make_gemm_fragment_b_hcu",
           [](int block_m, int block_n, int block_k, int num_warp_m,
              int num_warp_n, int num_warp_k, int element_bits, int k_pack,
