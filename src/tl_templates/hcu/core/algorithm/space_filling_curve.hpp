...
struct space_filling_curve
{
    ...
    static TL_HOST_DEVICE constexpr auto get_step_between(number<AccessIdx1dHead>,
    ...
    static TL_HOST_DEVICE constexpr auto get_forward_step(number<AccessIdx1d>)
    {
    ...
    template <index_t AccessIdx1d>
    static TL_HOST_DEVICE constexpr auto get_backward_step(number<AccessIdx1d>)
    {
    ...
    template <index_t AccessIdx1d>
    static TL_HOST_DEVICE constexpr Index _get_index(number<AccessIdx1d>)
    {
#if 0
        /*
    ...
    template <index_t AccessIdx1d>
    static TL_HOST_DEVICE constexpr auto get_index(number<AccessIdx1d>)
    {
