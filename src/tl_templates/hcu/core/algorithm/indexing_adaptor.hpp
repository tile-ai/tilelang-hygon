...
struct indexing_adaptor_onshot_cached
{
    ...
    TL_HOST_DEVICE constexpr indexing_adaptor_onshot_cached() = default;
    TL_HOST_DEVICE constexpr indexing_adaptor_onshot_cached(const IndexingType& idx)
        : cached_idx_(idx)
    {
    }
    ...
    {
        return tl::is_known_at_compile_time<IndexingType>::value;
    }
};
} // namespace tl
