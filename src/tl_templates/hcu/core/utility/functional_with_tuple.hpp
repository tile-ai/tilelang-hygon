...
{
    TL_HOST_DEVICE constexpr static_uford_impl()
    {
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, CurrentUnpackIds) const
    {
...
struct static_uford_impl<sequence<>, sequence<>, Orders>
{
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, PackedId) const
    {
...
struct static_uford_one_shot_impl
{
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, CurrentUnpackIds, number<current_acc>) const
    {
...
struct static_uford_one_shot_impl<sequence<>, sequence<>, Orders>
{
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, PackedId, number<current_acc>) const
    {
        constexpr auto origin_packs = transform_tuples(
            [](auto pack_) { return decltype(pack_)::reorder_old_to_new(Orders{}); }, PackedId{});
        unpack(f, origin_packs);
...
struct static_uford
{
    ...
    TL_HOST_DEVICE constexpr static_uford()
    {
    ...
    TL_HOST_DEVICE static constexpr index_t get_num_of_access()
    {
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, number<i_access>) const
    {
