...
struct swallow
{
    ...
    TL_HOST_DEVICE constexpr swallow(Ts&&...)
    {
    }
};
...
{
    template <class F>
    TL_HOST_DEVICE constexpr void operator()(F f) const
    {
...
struct static_for
{
    TL_HOST_DEVICE constexpr static_for()
    {
...
{
    template <typename T>
    TL_HOST_DEVICE constexpr T&& operator()(T&& arg) const noexcept
    {
...
{
    TL_HOST_DEVICE constexpr static_ford_impl()
    {
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, CurrentOrderedId) const
    {
...
struct static_ford_impl<sequence<>, Orders>
{
    ...
    TL_HOST_DEVICE constexpr void operator()(F f, OrderedId) const
    {
...
struct static_ford
{
    TL_HOST_DEVICE constexpr static_ford()
    {
...
struct unpack_impl<sequence<Is...>>
{
    ...
    TL_HOST_DEVICE constexpr auto operator()(F&& f, X&& x) const
    {
#if 0
...
struct unpack2_impl<sequence<Is...>, sequence<Js...>>
{
    ...
    TL_HOST_DEVICE constexpr auto operator()(F&& f, X&& x, Y&& y) const
    {
#if 0
        return std::forward<F>(f)(std::forward<X>(x).at(number<Is>{})...,
...
template <typename F, typename X>
TL_HOST_DEVICE constexpr auto unpack(F&& f, X&& x)
{
...
template <typename F, typename X, typename Y>
TL_HOST_DEVICE constexpr auto unpack2(F&& f, X&& x, Y&& y)
{
    using X_ = remove_reference_t<X>;
