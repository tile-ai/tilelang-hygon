...
struct tensor_adaptor_coordinate
{
    ...
    public:
    TL_HOST_DEVICE constexpr tensor_adaptor_coordinate() = default;

    TL_HOST_DEVICE constexpr tensor_adaptor_coordinate(const HiddenIndex& idx_hidden)
        : idx_hidden_{idx_hidden}
    {
    }

    TL_HOST_DEVICE constexpr auto get_top_index() const
    {
        return get_container_subset(idx_hidden_, TopDimensionHiddenIds{});
    }

    TL_HOST_DEVICE constexpr auto get_bottom_index() const
    {
        return get_container_subset(idx_hidden_, BottomDimensionHiddenIds{});
    }

    TL_HOST_DEVICE constexpr const auto& get_hidden_index() const { return idx_hidden_; }

    TL_HOST_DEVICE constexpr auto& get_hidden_index() { return idx_hidden_; }
...
TL_HOST_DEVICE constexpr auto make_tensor_adaptor_coordinate(const Adaptor& adaptor,
...
TL_HOST_DEVICE constexpr void move_tensor_adaptor_coordinate(const Adaptor& adaptor,
                                                                  AdaptorCoord& coord,
...
TL_HOST_DEVICE constexpr bool adaptor_coordinate_is_valid(const Adaptor& adaptor,
