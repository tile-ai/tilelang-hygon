...
{
    TL_HOST_DEVICE static constexpr index_t get_num_of_transform()
    {
        return Transforms::size();
    }

    TL_HOST_DEVICE constexpr const auto& get_transforms() const { return transforms_; }

    TL_HOST_DEVICE static constexpr auto get_lower_dimension_hidden_idss()
    {
        return LowerDimensionHiddenIdss{};
    }

    TL_HOST_DEVICE static constexpr auto get_upper_dimension_hidden_idss()
    {
        return UpperDimensionHiddenIdss{};
    }

    TL_HOST_DEVICE static constexpr auto get_bottom_dimension_hidden_ids()
    {
        return BottomDimensionHiddenIds{};
    }

    TL_HOST_DEVICE static constexpr auto get_top_dimension_hidden_ids()
    {
        return TopDimensionHiddenIds{};
    }

    TL_HOST_DEVICE static constexpr auto initialize_element_size(const Transforms& transforms)
    {
    ...
    TL_HOST_DEVICE static constexpr index_t get_num_of_bottom_dimension()
    {
        return BottomDimensionHiddenIds::size();
    }

    TL_HOST_DEVICE static constexpr index_t get_num_of_top_dimension()
    {
        return TopDimensionHiddenIds::size();
    }

    TL_HOST_DEVICE static constexpr index_t get_num_of_hidden_dimension()
    {
    ...
    public:
    TL_HOST_DEVICE constexpr tensor_adaptor() = default;

    TL_HOST_DEVICE constexpr tensor_adaptor(const Transforms& transforms)
    ...
    TL_HOST_DEVICE constexpr auto get_element_size() const { return element_size_; }

    // FIXME: this logic is wrong when getting bottome dimension lengths
    template <index_t IDimHidden>
    TL_HOST_DEVICE constexpr auto get_hidden_dimension_length(number<IDimHidden>) const
    {
    ...
    TL_HOST_DEVICE constexpr auto get_top_dimension_length(number<IDimTop> idim_top) const
    {
    ...
    TL_HOST_DEVICE constexpr auto get_top_dimension_lengths() const
    {
...
#if 0
    // FIXME: get_hidden_dimension_length is wrong when getting bottome dimension lengths
    TL_HOST_DEVICE constexpr auto GetBottomDimensionLengths() const
    {
    ...
    TL_HOST_DEVICE constexpr auto calculate_bottom_index(const TopIdx& idx_top) const
    {
    ...
    TL_HOST_DEVICE static constexpr bool is_static()
    {
        ...
        return is_known && tl::is_known_at_compile_time<ElementSize>::value;
    }

    TL_HOST_DEVICE static constexpr bool is_known_at_compile_time() { return is_static(); }

    TL_HOST_DEVICE static constexpr auto get_top_dimension_safe_vector_length_strides(
...
TL_HOST_DEVICE constexpr auto make_single_stage_tensor_adaptor(const Transforms& transforms,
...
{
    template <typename I>
    TL_HOST_DEVICE constexpr auto operator()(I) const
    {
...
TL_HOST_DEVICE constexpr auto chain_tensor_adaptors(const TensorAdaptor0& adaptor0,
...
TL_HOST_DEVICE constexpr auto chain_tensor_adaptors(const X& x, const Xs&... xs)
{
