...
struct tile_distribution_encoding
{
    ...
    struct detail
    {
        ...
        TL_HOST_DEVICE static constexpr auto get_h_dim_lengths_prefix_sum()
        {
            // <len_d0, len_d1, ...>
        ...
        TL_HOST_DEVICE static constexpr auto get_uniformed_idx_y_to_h()
        {
        ...
        TL_HOST_DEVICE static constexpr auto get_sorted_info(IdxSeq, PrefixSumSeq)
        {
        ...
        TL_HOST_DEVICE static constexpr auto get_sorted_y_info()
        {
...
TL_HOST_DEVICE constexpr auto make_embed_tile_distribution_encoding(OuterDstr, InnerDstr)
{
