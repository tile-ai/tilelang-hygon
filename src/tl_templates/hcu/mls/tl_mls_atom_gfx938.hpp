...
/*
 * tilelang MlsAtom for gfx938 - load() uses __builtin_hcu_matrix_load_* instead of inline asm.
 * Ported from ck_tile/core/arch/hcu_mls_atom_gfx938.hpp.
 */
...
struct gfx938_mls_32x16_b16
{
    ...
    template <ck_tile::index_t moffset, bool r>
...
struct gfx938_mls_16x32_trans_b16
{
                                    ...
                                    ck_tile::bool_constant<r>)
    {
        __builtin_hcu_matrix_load_32X16_b16(
            rsrc,
            reinterpret_cast<uint32_t*>(lds_addr | CK_TILE_MATRIX_LOAD_TRANS_EXTRA_CONFIG),
...
struct gfx938_mls_16x64_trans_b16
{
                                    ...
                                    ck_tile::bool_constant<r>)
    {
        ...
        const auto soffset = static_cast<uint32_t>(
            lds_addr | CK_TILE_MATRIX_LOAD_TRANS_EXTRA_CONFIG);
        if constexpr(!r)
        {
