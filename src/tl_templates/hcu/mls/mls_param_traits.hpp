 ...
 */
template <typename BlockSize, typename MlsTileSize, ::tl::index_t Bits,
...
struct mls_lds_desc_param_traits {
  ...
  using MlsAtom = typename mls_atom_for_tile<MlsTileMN, MlsTileK, Trans, Bits,
                                             HcuArch>::Type;
 ...
 * (::tl::sequence<MN,K>), WarpMN, WarpK, Bits (element size in bits, e.g. 16
 * for b16), Alt, Trans, HcuArch.
 */
template <typename BlockSize, typename MlsTileSize, ::tl::index_t WarpMN,
          ::tl::index_t WarpK, ::tl::index_t Bits, ::tl::index_t Alt,
          bool Trans, ::tl::hcu_target_enum HcuArch>
